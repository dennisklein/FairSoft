################################################################################
#   Copyright (C) 2020 GSI Helmholtzzentr um fuer Schwerionenforschung GmbH    #
#                                                                              #
...
ExternalProject_Add(dds
  GIT_REPOSITORY https://github.com/FairRootGroup/DDS
  GIT_TAG 3.5.2
  ${CMAKE_DEFAULT_ARGS}
  CMAKE_ARGS "-DBoost_NO_BOOST_CMAKE=ON"
  PATCH_COMMAND $<TARGET_FILE:Patch::patch> -N -p1 < "${CMAKE_SOURCE_DIR}/legacy/dds/fix_boost_lookup.patch"
  BUILD_COMMAND ${CMAKE_COMMAND} --build . --target wn_bin
  COMMAND ${CMAKE_COMMAND} --build .
  DEPENDS boost
)

ExternalProject_Add(fairlogger
  GIT_REPOSITORY https://github.com/FairRootGroup/FairLogger
  GIT_TAG v1.8.0
  ${CMAKE_DEFAULT_ARGS}
  CMAKE_ARGS "-DUSE_EXTERNAL_FMT=ON"
  DEPENDS boost fmt
)
