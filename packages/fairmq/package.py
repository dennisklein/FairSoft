...
class Fairmq(CMakePackage):
    ...
    depends_on('boost@1.64: +container+program_options+filesystem+date_time+regex', when='@1.4,develop')
    ...
    depends_on('dds@3.0:', when='@1.4.11:,develop')
    depends_on('flatbuffers', when='@1.4.9:,develop')
    depends_on('pmix@2.1.4:', when='@1.4:,develop')
